...
function FreeShippingPopup({
  ...
  return (
    <div
      className={clx(
        "fixed bottom-5 right-5 left-5 small:left-auto flex flex-col items-end gap-2 transition-all duration-500 ease-in-out z-10",
        {
    ...
    >
      ...
      <div className="w-full small:w-[400px] bg-black text-white p-4 small:p-6 rounded-lg ">
        <div className="pb-4">
        ...
        <div className="flex gap-3">
          <LocalizedClientLink
            className="rounded-2xl bg-transparent shadow-none outline-none border border-gray-900 text-gray-900 text-[15px] py-2.5 px-4"
            href="/cart"
          >
            View cart
          </LocalizedClientLink>
          ...
          <LocalizedClientLink
            className="flex-grow rounded-2xl bg-gray-900 text-white shadow-none outline-none border border-gray-900 text-[15px] py-2.5 px-4 text-center"
            href="/store"
          >
            View products
          </LocalizedClientLink>
