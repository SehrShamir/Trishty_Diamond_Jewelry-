...
module.exports = {
  ...
  theme: {
    // Blue Nile breakpoints - completely replaces Medusa preset breakpoints
    screens: {
      "2xsmall": "320px",
      xsmall: "512px",
      small: "1024px",
    ...
    extend: {
      colors: {
        ...
        // Trishty theme colors
        "card-cream": "#F7EFDF",
        "card-subtle": "#f5f5f5",
        // Existing grey scale preserved
        grey: {
          0: "#FFFFFF",
          5: "#F9FAFB",
          10: "#F3F4F6",
      ...
      fontSize: {
        ...
        md: ["1rem", { lineHeight: "1.125rem" }], // 16px / 18px
        lg: ["1.25rem", { lineHeight: "1.25rem" }], // 20px / 20px
        xl: ["1.5rem", { lineHeight: "1.625rem" }], // 24px / 26px
        "2xl": ["2rem", { lineHeight: "normal" }], // 32px
        "3xl": ["2.75rem", { lineHeight: "3.5rem" }], // 44px / 56px
      },
      fontWeight: {
        normal: "400",
        medium: "500",
