...
module.exports = function getConfigProperties() {
    const configProperties = {
        ...
        // Ghost's newsletter UI still uses this capability flag for the
        // publish-and-email controls, even when the active provider is Loops.
        mailgunIsConfigured: !!((config.get('bulkEmail') && config.get('bulkEmail').mailgun) || settingsCache.get('loops_api_key') || process.env.LOOPS_API_KEY),
